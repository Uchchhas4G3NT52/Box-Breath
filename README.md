...
Add Audio Files: Because audio files are subjective, they are not included by default. You must add two short audio clips to the root directory of the project and name them exactly:
...
Click Save and wait 1-3 minutes for deployment.
...
Inhale (4 seconds): Draw breath in slowly and deeply.

Hold (4 seconds): Keep your lungs full without straining.

Exhale (4 seconds): Release the air steadily.

Hold Empty (4 seconds): Keep your lungs empty before the next breath.
...
3. Name the file `README.md` (exactly like that, with capital letters).
4. Paste the markdown code provided above into the editor.
5. Click the green **Commit changes** button. 

This will automatically create a beautiful landing page on your GitHub repository explaining your project!
